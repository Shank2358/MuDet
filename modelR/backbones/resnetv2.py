...
class ResNet(nn.Module):
    def __init__(self, weight_path=None, width_mult=36):
        super(ResNet, self).__init__()
        #152[3, 8, 36, 3] 101[3, 4, 23, 3] 50[3, 4, 6, 3] 18 [2, 2, 2, 2]
        self.__model = _ResNet(Bottleneck, [3, 8, width_mult, 3])

        if weight_path:
            print("*" * 40, "\nLoading weight of ResNeSt : {}".format(weight_path))
            ...
            del pretrained_dict
            print("Loaded weight of ResNet152 : {}".format(weight_path))

    def forward(self, x):
        x2, x3, x4 = self.__model(x)
        return x2, x3, x4
'''
...
class ResNet(nn.Module):
    def __init__(self):
        ...
        #state_dict = torch.load('./weight/resnet152-b121ed2d.pth')
